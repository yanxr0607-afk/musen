...
const PLATFORMS_BY_CAT = {
  'AI 原生服务类':   ['BOSS直聘', '前程无忧', '猪八戒', '闲鱼'],
  '本地商家赋能类': ['58同城', 'BOSS直聘', '抖音', '美团'],
  '情绪陪伴经济类': ['BOSS直聘', '闲鱼', '抖音', '小红书'],
  '数字产品内容类': ['BOSS直聘', '猪八戒', '闲鱼', '淘宝'],
  '便民生活服务类': ['58同城', 'BOSS直聘', '美团', '小区社群'],
  '轻技术工具类':   ['前程无忧', 'BOSS直聘', '猪八戒', '掘金'],
  '内容生产变现类': ['BOSS直聘', '猪八戒', '知乎', '抖音'],
  '企业服务提效类': ['BOSS直聘', '前程无忧', '猪八戒', '闲鱼'],
  '视觉设计生产类': ['猪八戒', 'BOSS直聘', '站酷', '闲鱼'],
};

/* 各接单 / 招聘平台的「公开搜索」直达链接（{q} 占位符会被「兼职+赛道精准词」替换）。
   - 仅收录「专职招聘 / 接单众包」且中文检索能命中结果的平台；小红书 / 公众号 / 知乎 / 站酷 / 淘宝 等
     社媒或内容平台因登录墙 / 反爬，作为「参考渠道」仅展示为灰色标签、不生成跳转链接（避免点到空结果）。
   - 58同城 / 兼职猫 无通用搜索参数，跳转对应兼职频道首页由用户自行检索。 */
