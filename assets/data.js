...
const PLATFORMS_BY_CAT = {
  'AI 原生服务类':   ['微信社群', '企业微信', '闲鱼', '抖音'],
  '本地商家赋能类': ['美团', '抖音本地生活', '微信私域', '大众点评'],
  '情绪陪伴经济类': ['小红书', '微信私域', '知识星球', '抖音'],
  '数字产品内容类': ['小红书', '公众号', '闲鱼', '淘宝', '抖音'],
  '便民生活服务类': ['美团', '58同城', '微信私域', '小区社群'],
  '轻技术工具类':   ['ProductHunt', '独立站', '微信私域', '掘金'],
  '内容生产变现类': ['小红书', '公众号', '知乎', '抖音'],
  '企业服务提效类': ['微信社群', '脉脉', '企业服务市场', '闲鱼'],
