...
const PLATFORMS_BY_CAT = {
  'AI 原生服务类':   ['BOSS直聘', '前程无忧', '智联招聘', '猎聘', '掘金', '百度', '搜狗', '360'],
  '本地商家赋能类': ['58同城', 'BOSS直聘', '智联招聘', '抖音', '百度', '搜狗', '360'],
  '情绪陪伴经济类': ['BOSS直聘', '智联招聘', '闲鱼', '抖音', '百度', '搜狗', '360'],
  '数字产品内容类': ['BOSS直聘', '猪八戒', '前程无忧', '闲鱼', '掘金', '百度', '搜狗', '360'],
  '便民生活服务类': ['58同城', 'BOSS直聘', '智联招聘', '闲鱼', '百度', '搜狗', '360'],
  '轻技术工具类':   ['前程无忧', 'BOSS直聘', '智联招聘', '猎聘', '掘金', '百度', '搜狗', '360'],
  '内容生产变现类': ['BOSS直聘', '猪八戒', '智联招聘', '抖音', '掘金', '百度', '搜狗', '360'],
  '企业服务提效类': ['BOSS直聘', '前程无忧', '智联招聘', '猪八戒', '百度', '搜狗', '360'],
  '视觉设计生产类': ['猪八戒', 'BOSS直聘', '智联招聘', '闲鱼', '掘金', '百度', '搜狗', '360'],
};
